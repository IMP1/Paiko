...
function Piece.new(id)
    ...
    this.name = "Sword"
    this.quads = {
        love.graphics.newQuad(0 * TileSize, 0 * TileSize, TileSize, TileSize, PieceImage:getWidth(), PieceImage:getHeight()), -- Player 1
        love.graphics.newQuad(0 * TileSize, 1 * TileSize, TileSize, TileSize, PieceImage:getWidth(), PieceImage:getHeight()), -- Player 2
    }
    this.id = id
    this.x = -1
    this.y = -1
...
function Piece:isDefending(x, y)
    return false -- Sword doesn't defend any tiles
end
